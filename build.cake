...
var isRepository = StringComparer.OrdinalIgnoreCase.Equals("dpvreony/nettestregimentation", AppVeyor.Environment.Repository.Name);
    ...
    .Does(() =>
{
    ...
    OpenCover(testAction,
        ...
        .WithFilter("+[NetTestRegimentation]*")
