...
namespace NetTestRegimentation
{
    ...
    public interface ITestConstructorMethodWithNullableParameters<in TArg1, in TArg2, in TArg3, in TArg4, in TArg5>
        : ITestConstructorMethod, NetTestRegimentation.ITestMethodWithNullableParameters<TArg1, TArg2, TArg3, TArg4, TArg5>
    {
    }
}
