...
{
    /// <summary>
    /// Theory Data for testing a method that validates the 6 arguments that are not null.
    /// </summary>
    ...
    public class ArgumentNullExceptionTheoryData<T1, T2, T3, T4, T5, T6>
        : global::Xunit.TheoryData<T1?, T2?, T3?, T4?, T5?, T6?, string>
        where T1 : notnull
        where T2 : notnull
        where T3 : notnull
        where T4 : notnull
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArgumentNullExceptionTheoryData{T1, T2, T3, T4, T5, T6}"/> class.
        /// </summary>
