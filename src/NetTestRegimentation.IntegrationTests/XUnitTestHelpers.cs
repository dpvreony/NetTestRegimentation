...
namespace NetTestRegimentation.IntegrationTests
{
    ...
    public static class XUnitTestHelpers
    {
        ...
        /// </summary>
        /// <param name="rootCommand">The root command that defines the entry point and structure of the command-line interface.</param>
        ...
        /// <returns>A <see cref="CommandLineConfiguration"/> object configured with the specified root command, output writer,
        /// and error writer.</returns>
        public static CommandLineConfiguration CreateTestConsoleIntegration(
