...
#pragma warning disable SA1402 // File may only contain a single type
    /// <summary>
    /// Unit Tests for method that contain 1 parameters that needs validation.
    /// </summary>
    /// <typeparam name="TArg">Type for the 1st argument.</typeparam>
    ...
    /// <summary>
    /// Unit Tests for methods that contain sixteen parameters that need validation.
    /// </summary>
