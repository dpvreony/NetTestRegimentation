...
namespace NetTestRegimentation
{
    ...
    public interface ITestAsyncMethodWithParameterValidation<in TArg1, in TArg2, in TArg3, in TArg4>
    {
        Task ThrowsArgumentExceptionAsync(
            TArg1 arg1,
            TArg2 arg2,
    ...
    public interface ITestAsyncMethodWithParameterValidation<in TArg1, in TArg2, in TArg3, in TArg4, in TArg5, in TArg6>
    {
        Task ThrowsArgumentExceptionAsync(
            TArg1 arg1,
            TArg2 arg2,
    ...
    public interface ITestAsyncMethodWithParameterValidation<in TArg1, in TArg2, in TArg3, in TArg4, in TArg5, in TArg6, in TArg7>
    {
        Task ThrowsArgumentExceptionAsync(
            TArg1 arg1,
            TArg2 arg2,
